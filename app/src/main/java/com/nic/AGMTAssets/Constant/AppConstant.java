package com.nic.AGMTAssets.Constant;
...
public class AppConstant {
    ...
    public static String KEY_ROAD_LAT = "road_lat";
    ...
    public static String KEY_HABITATION_IMAGE = "pmgsy_habitation_location_view";
    ...
    public static String KEY_HAB_NAME = "pmgsy_habname";
